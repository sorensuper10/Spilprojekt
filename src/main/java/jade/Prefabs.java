...
public class Prefabs {
    ...
    public static GameObject generateMario() {
        ...
        Spritesheet bigPlayerSprites = AssetPool.getSpritesheet("assets/images/spritesheet35.png");
        Spritesheet firePlayerSprites = AssetPool.getSpritesheet("assets/images/spritesheet8.png");
        ...
        bigSwitchDirection.addFrame(bigPlayerSprites.getSprite(0), 0.1f);
        ...
        bigJump.addFrame(bigPlayerSprites.getSprite(0), 0.1f);
        ...
        fireRun.addFrame(firePlayerSprites.getSprite(fireOffset + 2), defaultFrameTime);
        fireRun.addFrame(firePlayerSprites.getSprite(fireOffset + 2), defaultFrameTime);
        fireRun.addFrame(firePlayerSprites.getSprite(fireOffset + 2), defaultFrameTime);
        fireRun.addFrame(firePlayerSprites.getSprite(fireOffset + 2), defaultFrameTime);
        fireRun.addFrame(firePlayerSprites.getSprite(fireOffset + 2), defaultFrameTime);
        ...
        fireSwitchDirection.addFrame(firePlayerSprites.getSprite(fireOffset + 2), 0.1f);
        fireSwitchDirection.setLoop(false);

        AnimationState fireIdle = new AnimationState();
        fireIdle.title = "FireIdle";
        fireIdle.addFrame(firePlayerSprites.getSprite(fireOffset + 2), 0.1f);
        fireIdle.setLoop(false);

        AnimationState fireJump = new AnimationState();
        fireJump.title = "FireJump";
        fireJump.addFrame(firePlayerSprites.getSprite(fireOffset + 2), 0.1f);
    ...
    public static GameObject generateMario1() {
        Spritesheet playerSprites = AssetPool.getSpritesheet("assets/images/spritesheet7.png");
        Spritesheet bigPlayerSprites = AssetPool.getSpritesheet("assets/images/spritesheet7.png");
        GameObject mario = generateSpriteObject(playerSprites.getSprite(0), 0.25f, 0.25f);
        ...
        AnimationState switchDirection = new AnimationState();
        switchDirection.title = "Switch Direction";
        switchDirection.addFrame(playerSprites.getSprite(1), 0.1f);
        switchDirection.setLoop(false);
        ...
        AnimationState jump = new AnimationState();
        jump.title = "Jump";
        jump.addFrame(playerSprites.getSprite(1), 0.1f);
        jump.setLoop(false);
        ...
        AnimationState bigJump = new AnimationState();
        bigJump.title = "BigJump";
        bigJump.addFrame(bigPlayerSprites.getSprite(1), 0.1f);
        bigJump.setLoop(false);
        ...
        AnimationState fireSwitchDirection = new AnimationState();
        fireSwitchDirection.title = "Fire Switch Direction";
        fireSwitchDirection.addFrame(bigPlayerSprites.getSprite(fireOffset + 1), 0.1f);
        fireSwitchDirection.setLoop(false);
        ...
        AnimationState fireJump = new AnimationState();
        fireJump.title = "FireJump";
        fireJump.addFrame(bigPlayerSprites.getSprite(fireOffset + 1), 0.1f);
        fireJump.setLoop(false);

        AnimationState die = new AnimationState();
        die.title = "Die";
        die.addFrame(playerSprites.getSprite(1), 0.1f);
        die.setLoop(false);
    ...
    public static GameObject generateQuestionBlock() {
        ...
        flicker.addFrame(playerSprites.getSprite(1), 0.57f);
    ...
    public static GameObject generateBlockCoin() {
        Spritesheet items = AssetPool.getSpritesheet("assets/images/spritesheet14.png");
        GameObject coin = generateSpriteObject(items.getSprite(1), 0.25f, 0.25f);

        AnimationState coinFlip = new AnimationState();
        coinFlip.title = "CoinFlip";
        float defaultFrameTime = 0.23f;
        coinFlip.addFrame(items.getSprite(1), 0.57f);
        coinFlip.addFrame(items.getSprite(1), defaultFrameTime);
        coinFlip.addFrame(items.getSprite(1), defaultFrameTime);
    ...
    public static GameObject generateGoomba() {
        Spritesheet sprites = AssetPool.getSpritesheet("assets/images/spritesheet28.png");
        GameObject goomba = generateSpriteObject(sprites.getSprite(2), 0.25f, 0.25f);

        AnimationState walk = new AnimationState();
        walk.title = "Walk";
        float defaultFrameTime = 0.23f;
        walk.addFrame(sprites.getSprite(2), defaultFrameTime);
        walk.addFrame(sprites.getSprite(2), defaultFrameTime);
        walk.setLoop(true);
    ...
    public static GameObject generateTurtle() {
        Spritesheet turtleSprites = AssetPool.getSpritesheet("assets/images/spritesheet28.png");
        ...
        squashed.addFrame(turtleSprites.getSprite(0), 0.1f);
        squashed.setLoop(false);
    ...
    public static GameObject generateFireball(Vector2f position) {
        Spritesheet items = AssetPool.getSpritesheet("assets/images/spritesheet12.png");
        GameObject fireball = generateSpriteObject(items.getSprite(1), 0.18f, 0.18f);
    ...
    public static GameObject generateFlagtop() {
        Spritesheet items = AssetPool.getSpritesheet("assets/images/spritesheet25.png");
        GameObject flagtop = generateSpriteObject(items.getSprite(1), 0.25f, 0.25f);
    ...
    public static GameObject generateFlagPole() {
        Spritesheet items = AssetPool.getSpritesheet("assets/images/spritesheet25.png");
        GameObject flagtop = generateSpriteObject(items.getSprite(3), 0.25f, 0.25f);
    ...
    public static GameObject generateMushroom() {
        Spritesheet items = AssetPool.getSpritesheet("assets/images/spritesheet13.png");
        GameObject mushroom = generateSpriteObject(items.getSprite(1), 0.25f, 0.25f);
    ...
    public static GameObject generateFlower() {
        Spritesheet items = AssetPool.getSpritesheet("assets/images/spritesheet12.png");
        GameObject flower = generateSpriteObject(items.getSprite(1), 0.25f, 0.25f);
