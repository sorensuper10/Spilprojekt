...
public class PlayerController extends Component {
    ...
    public void update(float dt) {
        if (playWinAnimation) {
            ...
            if (!onGround) {
                ...
                if (!AssetPool.getSound("assets/sounds/suiii.ogg").isPlaying()) {
                   //AssetPool.getSound("assets/sounds/suiii.ogg").play();
                }
                timeToCastle -= dt;
                walkTime -= dt;
        ...
        if (KeyListener.isKeyPressed(GLFW_KEY_SPACE) && (jumpTime > 0 || onGround || groundDebounce > 0)) {
            if ((onGround || groundDebounce > 0) && jumpTime == 0) {
                AssetPool.getSound("assets/sounds/mariojump.ogg").play();
                jumpTime = 28;
    ...
    public void die() {
        ...
        if (this.playerState == PlayerState.Small) {
            ...
            this.isDead = true;
            this.rb.setIsSensor();
            AssetPool.getSound("assets/sounds/mariodie.ogg").play();
